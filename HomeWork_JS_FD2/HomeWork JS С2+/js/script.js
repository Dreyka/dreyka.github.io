    ...
    function objects(elem) {
        if (Array.isArray(elem)) {
            ...
            for (let i = 0; i < newElem.length; i++) {
                if ((Array.isArray(newElem[i])) ||
                    (typeof (newElem[i]) === "object" && newElem[i] !== null && !Array.isArray(newElem[i]))) {
                    newElem.splice(i, 1, objects(newElem[i]));
                }
                ;
            }
            ;
        ...
        if (typeof (elem) === "object" && elem !== null && !Array.isArray(elem)) {
            ...
            for (let k in elem) {
                if ((Array.isArray(elem[k])) ||
                    (typeof (elem[k]) === "object") && (elem[k] !== null) && (!Array.isArray(elem[k]))) {
