...
let str = "(45-93)/(76+5*(4.79-7*0.1))+45-6.7";
...
console.log("Значение выражения (45-93)/(76+5*(4.79-7*0.1))+45-6.7 через нашу функцию calc   " + priority(mass, m = 0));
console.log("Значение выражения (45-93)/(76+5*(4.79-7*0.1))+45-6.7 через нашу функцию eval   " + eval("(45-93)/(76+5*(4.79-7*0.1))+45-6.7"));
